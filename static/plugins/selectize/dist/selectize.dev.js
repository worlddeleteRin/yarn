...
!function (e, t) {
  "function" == typeof define && define.amd ? define("sifter", t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = t() : e.Sifter = t();
}(void 0, function () {
  function e(e, t) {
  ...
  e.prototype.tokenize = function (e) {
    ...
    for (var t, n, i = [], o = e.split(/ +/), s = 0, r = o.length; s < r; s++) {
      if (t = l(o[s]), this.settings.diacritics) for (n in p) {
    ...
    if (c) for (t = 0, i = c.length; t < i; t++) {
      !e.query && "$score" === c[t].field || u.push(c[t]);
    }

    if (e.query) {
      for (l = !0, t = 0, i = u.length; t < i; t++) {
        if ("$score" === u[t].field) {
          l = !1;
          break;
        }
    ...
    return (s = u.length) ? 1 === s ? (o = u[0].field, r = a[0], function (e, t) {
      ...
      for (var n, i = 0; i < s; i++) {
        if (n = u[i].field, n = a[i] * h(d(n, e), d(n, t))) return n;
      }
  ...
  var h = function h(e, t) {
    ...
    for (n in p) {
      if (p.hasOwnProperty(n)) for (o += i = p[n].substring(2, p[n].length - 1), e = 0, t = i.length; e < t; e++) {
        s[i.charAt(e)] = n;
      }
    }
  ...
  "function" == typeof define && define.amd ? define("microplugin", t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = t() : e.MicroPlugin = t();
}(void 0, function () {
  var e = {
    mixin: function mixin(i) {
      i.plugins = {}, i.prototype.initializePlugins = function (e) {
        ...
        if (this.plugins = {
          ...
          requested: {},
          loaded: {}
        }, s.isArray(e)) for (t = 0, n = e.length; t < n; t++) {
          "string" == typeof e[t] ? o.push(e[t]) : (this.plugins.settings[e[t].name] = e[t].options, o.push(e[t].name));
        } else if (e) for (i in e) {
          e.hasOwnProperty(i) && (this.plugins.settings[i] = e[i], o.push(i));
        }
...
var highlight = function highlight(e, t) {
  if ("string" != typeof t || t.length) {
    var r = "string" == typeof t ? new RegExp(t, "i") : t,
      ...
      } else if (1 === e.nodeType && e.childNodes && !/(script|style)/i.test(e.tagName) && ("highlight" !== e.className || "SPAN" !== e.tagName)) for (var s = 0; s < e.childNodes.length; ++s) {
        s += a(e.childNodes[s]);
      }
...
var IS_MAC = /Mac/.test(navigator.userAgent),
  ...
  return void 0 !== e;
    ...
    hash_key = function hash_key(e) {
  return null == e ? null : "boolean" == typeof e ? e ? "1" : "0" : e + "";
},
    escape_html = function escape_html(e) {
  return (e + "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
},
    escape_replace = function escape_replace(e) {
  return (e + "").replace(/\$/g, "$$$$");
},
    hook = {
  ...
  return function () {
    ...
    debounce_events = function debounce_events(t, n, e) {
  var i,
      o = t.trigger,
      s = {};
  ...
  for (i in t.trigger = function () {
    ...
    s[e] = arguments;
  }, e.apply(t, []), t.trigger = o, s) {
    s.hasOwnProperty(i) && o.apply(t, s[i]);
  }
},
    watchChildEvent = function watchChildEvent(n, e, t, i) {
  n.on(e, t, function (e) {
  ...
  return "selectionStart" in e ? (i.start = e.selectionStart, i.length = e.selectionEnd - i.start) : document.selection && (e.focus(), t = document.selection.createRange(), n = document.selection.createRange().text.length, t.moveStart("character", -e.value.length), i.start = t.text.length - n, i.length = n), i;
    ...
    transferStyles = function transferStyles(e, t, n) {
  var i,
      o,
      s = {};
  ...
  t.css(s);
    ...
    measureString = function measureString(e, t) {
  ...
  r.on("keydown keyup update blur", e), e();
    ...
    domToString = function domToString(e) {
  var t = document.createElement("div");
  return t.appendChild(e.cloneNode(!0)), t.innerHTML;
},
    logError = function logError(e, t) {
  t = t || {};
  console.error("Selectize: " + e), t.explanation && (console.group && console.group(), console.error(t.explanation), console.group && console.groupEnd());
    ...
    Selectize = function Selectize(e, t) {
  var n,
      i,
      o = this,
      s = e[0];
...
MicroEvent.mixin(Selectize), "undefined" != typeof MicroPlugin ? MicroPlugin.mixin(Selectize) : logError("Dependency MicroPlugin is missing", {
  ...
  onPaste: function onPaste(e) {
    ...
    o.isFull() || o.isInputHidden || o.isLocked ? e.preventDefault() : o.settings.splitOn && setTimeout(function () {
      ...
      if (e.match(o.settings.splitOn)) for (var t = $.trim(e).split(o.settings.splitOn), n = 0, i = t.length; n < i; n++) {
        o.createItem(t[n]);
      }
    }, 0);
  },
  ...
  onSearchChange: function onSearchChange(t) {
    var n = this,
        i = n.settings.load;
  ...
  setTextboxValue: function setTextboxValue(e) {
  ...
  setActiveItem: function setActiveItem(e, t) {
    var n,
        i,
        o,
        s,
    ...
    if ("single" !== l.settings.mode) {
      ...
      if ("mousedown" === (i = t && t.type.toLowerCase()) && l.isShiftDown && l.$activeItems.length) {
        for (a = l.$control.children(".active:last"), o = Array.prototype.indexOf.apply(l.$control[0].childNodes, [a[0]]), (s = Array.prototype.indexOf.apply(l.$control[0].childNodes, [e[0]])) < o && (a = o, o = s, s = a), n = o; n <= s; n++) {
          r = l.$control[0].childNodes[n], -1 === l.$activeItems.indexOf(r) && ($(r).addClass("active"), l.$activeItems.push(r));
        }
  ...
  setActiveOption: function setActiveOption(e, t, n) {
    var i,
        o,
        s,
        r,
        a = this;
    a.$activeOption && (a.$activeOption.removeClass("active"), a.trigger("dropdown_item_deactivate", a.$activeOption.attr("data-value"))), a.$activeOption = null, (e = $(e)).length && (a.$activeOption = e.addClass("active"), a.isOpen && a.trigger("dropdown_item_activate", a.$activeOption.attr("data-value")), !t && isset(t) || (i = a.$dropdown_content.height(), o = a.$activeOption.outerHeight(!0), t = a.$dropdown_content.scrollTop() || 0, e = (r = s = a.$activeOption.offset().top - a.$dropdown_content.offset().top + t) - i + o, i + t < s + o ? a.$dropdown_content.stop().animate({
      scrollTop: e
  ...
  getScoreFunction: function getScoreFunction(e) {
  ...
  search: function search(e) {
    ...
    if (e !== o.lastQuery ? (o.lastQuery = e, n = o.sifter.search(e, $.extend(r, {
      score: i
    })), o.currentResults = n) : n = $.extend(!0, {}, o.currentResults), s.hideSelected) for (t = n.items.length - 1; 0 <= t; t--) {
      -1 !== o.items.indexOf(hash_key(n.items[t].id)) && n.items.splice(t, 1);
    }
    return n;
  },
  refreshOptions: function refreshOptions(e) {
    ...
    for ("number" == typeof f.settings.maxOptions && (C = Math.min(C, f.settings.maxOptions)), o = {}, s = [], t = 0; t < C; t++) {
      for (r = f.options[m.items[t].id], a = f.render("option", r), l = r[f.settings.optgroupField] || "", n = 0, i = (p = $.isArray(l) ? l : [l]) && p.length; n < i; n++) {
        l = p[n], f.optgroups.hasOwnProperty(l) || (l = ""), o.hasOwnProperty(l) || (o[l] = document.createDocumentFragment(), s.push(l)), o[l].appendChild(a);
      }
    }

    for (this.settings.lockOptgroupOrder && s.sort(function (e, t) {
      return (f.optgroups[e].$order || 0) - (f.optgroups[t].$order || 0);
    }), c = document.createDocumentFragment(), t = 0, C = s.length; t < C; t++) {
      l = s[t], f.optgroups.hasOwnProperty(l) && o[l].childNodes.length ? ((d = document.createDocumentFragment()).appendChild(f.render("optgroup_header", f.optgroups[l])), d.appendChild(o[l]), c.appendChild(f.render("optgroup", $.extend({}, f.optgroups[l], {
        html: domToString(d),
        dom: d
      })))) : c.appendChild(o[l]);
    }

    if (y.html(c), f.settings.highlight && (y.removeHighlight(), m.query.length && m.tokens.length)) for (t = 0, C = m.tokens.length; t < C; t++) {
      highlight(y, m.tokens[t].regex);
    }
    if (!f.settings.hideSelected) for (f.$dropdown.find(".selected").removeClass("selected"), t = 0, C = f.items.length; t < C; t++) {
      f.getOption(f.items[t]).addClass("selected");
    }
    (u = f.canCreate(v)) && (y.prepend(f.render("option_create", {
      input: v
    })), g = $(y[0].childNodes[0])), f.hasOptions = 0 < m.items.length || u, f.hasOptions ? (0 < m.items.length ? ((w = w && f.getOption(w)) && w.length ? h = w : "single" === f.settings.mode && f.items.length && (h = f.getOption(f.items[0])), h && h.length || (h = g && !f.settings.addPrecedence ? f.getAdjacentOption(g, 1) : y.find("[data-selectable]:first"))) : h = g, f.setActiveOption(h), e && !f.isOpen && f.open()) : (f.setActiveOption(null), e && f.isOpen && f.close());
  },
  ...
  clearOptions: function clearOptions(e) {
    var n = this;
  ...
  getAdjacentOption: function getAdjacentOption(e, t) {
    var n = this.$dropdown.find("[data-selectable]"),
        t = n.index(e) + t;
    return 0 <= t && t < n.length ? n.eq(t) : $();
  },
  getElementWithValue: function getElementWithValue(e, t) {
    if (null != (e = hash_key(e))) for (var n = 0, i = t.length; n < i; n++) {
      if (t[n].getAttribute("data-value") === e) return $(t[n]);
    }
    return $();
  },
  ...
  addItems: function addItems(e, t) {
    ...
    for (var o = $.isArray(e) ? e : [e], i = 0, s = o.length; i < s; i++) {
      this.isPending = i < s - 1, this.addItem(o[i], t);
    }
  ...
  removeItem: function removeItem(e, t) {
    ...
    e = hash_key(s.attr("data-value")), -1 !== (n = o.items.indexOf(e)) && (s.remove(), s.hasClass("active") && (i = o.$activeItems.indexOf(s[0]), o.$activeItems.splice(i, 1)), o.items.splice(n, 1), o.lastQuery = null, !o.settings.persist && o.userOptions.hasOwnProperty(e) && o.removeOption(e, t), n < o.caretPos && o.setCaret(o.caretPos - 1), o.refreshState(), o.updatePlaceholder(), o.updateOriginalInput({
      silent: t
    }), o.positionDropdown(), o.trigger("item_remove", e, s));
  },
  createItem: function createItem(e, n) {
    var i = this,
        o = i.caretPos;
    e = e || $.trim(i.$control_input.val() || "");
    var s = arguments[arguments.length - 1];
    if ("function" != typeof s && (s = function s() {}), "boolean" != typeof n && (n = !0), !i.canCreate(e)) return s(), !1;
    i.lock();
    var t = "function" == typeof i.settings.create ? this.settings.create : function (e) {
      ...
      return t[i.settings.labelField] = e, t[i.settings.valueField] = e, t;
        ...
        r = once(function (e) {
      if (i.unlock(), !e || "object" != _typeof(e)) return s();
  ...
  updateOriginalInput: function updateOriginalInput(e) {
    var t,
        n,
        i,
        o,
    ...
    if (e = e || {}, s.tagType === TAG_SELECT) {
      for (i = [], t = 0, n = s.items.length; t < n; t++) {
        o = s.options[s.items[t]][s.settings.labelField] || "", i.push('<option value="' + escape_html(s.items[t]) + '" selected="selected">' + escape_html(o) + "</option>");
      }
  ...
  updatePlaceholder: function updatePlaceholder() {
    var e;
    this.settings.placeholder && (e = this.$control_input, this.items.length ? e.removeAttr("placeholder") : e.attr("placeholder", this.settings.placeholder), e.triggerHandler("update", {
      force: !0
    }));
  },
  open: function open() {
  ...
  insertAtCaret: function insertAtCaret(e) {
  ...
  deleteSelection: function deleteSelection(e) {
    ...
    if (a.$activeOption && !a.settings.hideSelected && (o = a.getAdjacentOption(a.$activeOption, -1).attr("data-value")), i = [], a.$activeItems.length) {
      for (r = a.$control.children(".active:" + (0 < l ? "last" : "first")), r = a.$control.children(":not(input)").index(r), 0 < l && r++, t = 0, n = a.$activeItems.length; t < n; t++) {
  ...
  advanceSelection: function advanceSelection(e, t) {
    var n,
        i,
        o,
        s = this;
  ...
  advanceCaret: function advanceCaret(e, t) {
    var n,
        i = this;
  ...
  setCaret: function setCaret(e) {
    var t = this;
    if (e = "single" === t.settings.mode ? t.items.length : Math.max(0, Math.min(t.items.length, e)), !t.isPending) for (var n, i = t.$control.children(":not(input)"), o = 0, s = i.length; o < s; o++) {
      n = $(i[o]).detach(), o < e ? t.$control_input.before(n) : t.$control.append(n);
    }
    t.caretPos = e;
  },
  lock: function lock() {
  ...
  destroy: function destroy() {
    ...
    e.trigger("destroy"), e.off(), e.$wrapper.remove(), e.$dropdown.remove(), e.$input.html("").append(n.$children).removeAttr("tabindex").removeClass("selectized").attr({
      tabindex: n.tabindex
    }).show(), e.$control_input.removeData("grow"), e.$input.removeData("selectize"), 0 == --Selectize.count && Selectize.$testInput && (Selectize.$testInput.remove(), Selectize.$testInput = void 0), $(window).off(t), $(document).off(t), $(document.body).off(t), delete e.$input[0].selectize;
  },
  ...
  canCreate: function canCreate(e) {
  ...
  function o(e, r) {
    ...
    for (r.maxItems = e.attr("multiple") ? null : 1, t = 0, n = (o = e.children()).length; t < n; t++) {
      "optgroup" === (i = o[t].tagName.toLowerCase()) ? function (e) {
        var t, n, i, o, s;

        for ((i = (e = $(e)).attr("label")) && ((o = a(e) || {})[v] = i, o[m] = i, o[g] = e.prop("disabled"), r.optgroups.push(o)), t = 0, n = (s = $("option", e)).length; t < n; t++) {
          l(s[t], i);
        }
      }(o[t]) : "option" === i && l(o[t]);
    }
  ...
  return this.each(function () {
    ...
    this.selectize || (e = $(this), t = this.tagName.toLowerCase(), (n = e.attr("placeholder") || e.attr("data-placeholder")) || c.allowEmptyOption || (n = e.children('option[value=""]').text()), ("select" === t ? o : function (e, t) {
      var n,
          i = e.attr(d);
      if (i) for (t.options = JSON.parse(i), s = 0, r = t.options.length; s < r; s++) {
        t.items.push(t.options[s][h]);
      } else {
        i = $.trim(e.val() || "");

        if (c.allowEmptyOption || i.length) {
          for (var o, e = '(".*?"|[^"' + c.delimiter + "s]+)(?=s*" + c.delimiter + "|s*$)", e = new RegExp(e, "g"), s = 0, r = (o = i.match(e)).length; s < r; s++) {
            (n = {})[u] = o[s].replace(/"/g, ""), n[h] = o[s], t.options.push(n);
          }
